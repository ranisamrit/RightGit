       ...
       <ScrollView vartical={true}>
        ...
        Consignor Name
         ...
         18/02/2020,12:10 pm
          ...
          //   this.callApi()
              // this.props.navigation.navigate('InvoiceDetils')
              navigation.navigate('Consigmentdetailsform')
           }
       >
          <Text style={{ fontSize: 14,left:300,top:-5,color: '#602F56',fontFamily:"normal normal 300 14px/17px Inter",fontWeight:"bold" }}>
      Details  >
          </Text>
