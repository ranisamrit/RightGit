...
const Addinvoice = ({navigation}) => {
   ...
   return (
       ...
       >
            ...
            <Text style={{color:"#454F63",fontSize:11,textAlign:"center",
            fontFamily:" normal normal normal 14px/17px Inter",marginTop:15,marginRight:240,fontWeight:"bold"}}>Invoice Number</Text>
       ...
       >
            ...
            <Text style={styles.TextStyle1}>Add Multiple Invoice</Text>
       ...
       >
            ...
            <Text style={styles.TextStyle}>Save Invoice Detalis</Text>
